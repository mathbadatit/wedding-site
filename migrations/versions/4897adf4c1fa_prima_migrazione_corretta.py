"""Prima migrazione corretta

Revision ID: 4897adf4c1fa
Revises: 
Create Date: 2025-07-16 14:14:14.097711
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title_it', sa.String(length=200), nullable=True),
